...
* License: 
##Problem Definition
The general problem is forecasting stock prices, but a more refined specific problem is analyzing risk and return for different asset classes like stocks, ETFs, and bonds to find an optimal mix of investments that are secure while earning a return.

The rationale behind this refinement is the problem with focusing on a single type of asset. It's prone to changes within the overall market and is volatile. It can be predicted, but a single incident is enough to change future predictions. By refining the focus to comparing ratios between different types of assets, the approach is shifted to comparing different financial assets and finding combinations that would overall be more secure and practical to invest in compared to just individual stock movements.
...
|How to invest your money|Fidelity|https://drive.google.com/file/d/1H5teuPea9Lwp1jze5MkjvBBQjFoopYvR/view?usp=drive_link|Outlines a process for begining an investment journey and what to do.
...
|Trend Analysis 101|Equiti|https://drive.google.com/file/d/1CDLJ8bst698kdFNaBENzkBWR16PtsX02/view?usp=drive_link|Explains how to use historical price dta to identify market patterns and predict asset changes to help investors know when to buy or sell and leave.
